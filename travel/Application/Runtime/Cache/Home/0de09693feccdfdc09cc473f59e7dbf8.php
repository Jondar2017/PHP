            ...
            <div class="change_con">
                <dl>
                    ...
                    <dd>
                        ...
                        <?php if(is_array($level)): foreach($level as $key=>$v): ?><a href="<?php echo U('Home/SignCity/get_city_level?level_id='.$v['level_id'].'&view_city='.$view_city);?>"><?php echo ($v["level_name"]); ?></a><?php endforeach; endif; ?>
                    </dd>
