        ...
        <div class="box_change">
            <div class="change_con">
                <dl>
                    ...
                    <dd>
                        ...
                        <?php if(is_array($days)): foreach($days as $key=>$v): ?><a href="<?php echo U('Home/Line/get_days?days_id='.$v['days_id']);?>"><?php echo ($v["days_id"]); ?>日游</a><?php endforeach; endif; ?>
            ...
            <!--<div class="change_ing">-->
                <!--<dl>-->
                    <!--<dt>您已选择：</dt>-->
                    <!--<dd>-->
                        <!--<a href="" class="now_color">一日游<i></i></a>-->
                        <!--<a href="" class="btn_now">重新筛选</a>-->
                    <!--</dd>-->
                <!--</dl>-->
            <!--</div>-->
            <script>
