    ...
    <div class="box_list">
        <div class="box_change">
            <div class="change_con">
                <dl>
                    ...
                    <dd>
                        ...
                        <?php if(is_array($days)): foreach($days as $key=>$v): if($v["days_id"] == 1): ?><a href="<?php echo U('Home/LineCity/get_days?days_id='.$v['days_id'].'&city_name='.$city_name);?>" class="on">一日游</a>
            ...
            <div class="change_ing">
                ...
                <dt>您已选择：</dt>
                <dd>
                <a href="<?php echo U('Home/LineCity/index?city_name='.$city_name);?>" class="now_color">一日游<i></i></a>
