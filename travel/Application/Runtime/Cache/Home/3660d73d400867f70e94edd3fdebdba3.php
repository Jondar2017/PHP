            ...
            <div class="change_con">
                <dl>
                    ...
                    <dd>
                        ...
                        <?php if(is_array($days)): foreach($days as $key=>$v): ?><a href="<?php echo U('Home/LineCity/get_days?days_id='.$v['days_id'].'&city_name='.$city_name);?>"><?php echo ($v["days_id"]); ?>日游</a><?php endforeach; endif; ?>
                    </dd>
                </dl>
            </div>
            <script>
