       ...
       <div class="sideL">
           <div class="change_box">
               ...
               <div class="txt jd">
                   <dl>
                       ...
                       <dd class="jd_bg">
                           <a href="<?php echo U('cityHotel', 'city_id=1&hotel_type=经济型');?>"
                              target="_blank" title="广州酒店">广州</a>
                           <a href="#" target="_blank" title="深圳酒店">深圳</a>
                           <a href="#" target="_blank" title="东莞酒店">东莞</a>
                           <a href="#" target="_blank" title="惠州酒店">惠州</a>
                           <a href="#" target="_blank" title="中山酒店">中山</a>
                           <a href="#" target="_blank" title="佛山酒店">佛山</a>
                           <a href="#" target="_blank" title="珠海酒店">珠海</a>
                           <a href="#" target="_blank" title="韶关酒店">韶关</a>
                           <a href="#" target="_blank" title="湛江酒店">湛江</a>
                           <a href="#" target="_blank" title="阳江酒店">阳江</a>
                           <a href="#" target="_blank" title="清远酒店">清远</a>
                           <a href="#" target="_blank" title="汕头酒店">汕头</a>
                           <a href="#" target="_blank" title="肇庆酒店">肇庆</a>
                           <a href="#" target="_blank" title="茂名酒店">茂名</a>
                           <div class="more_box" id="more_box">
                               <a href="#" target="_blank" title="河源酒店">河源</a>
                               <a href="#" target="_blank" title="江门酒店">江门</a>
                               <a href="<?php echo U('cityHotel_4', 'city_id=12&hotel_type=四星级');?>"
                                  target="_blank" title="梅州酒店">梅州</a>
                               <a href="#" target="_blank" title="揭阳酒店">揭阳</a>
                               <a href="#" target="_blank" title="汕尾酒店">汕尾</a>
                               <a href="#" target="_blank" title="潮州酒店">潮州</a>
                               <a href="#" target="_blank" title="云浮酒店">云浮</a>
                           </div>
                       </dd>
                   </dl>
                   <dl>
                       <dt>酒店星级：</dt>
                       <dd id="hotel_type">
                           <a class="on" href="<?php echo U('index');?>">全部</a>
                           <a title="广东经济型酒店" href="<?php echo U('economics');?>">经济型酒店</a>
           ...
           <div class="hot_city mt20">
               ...
               <div class="con_cityHotel" id="cityHotel_con">
                   <div class="txt txt1" style="display: block;">
                       <ul>
                           <?php if(is_array($gz)): $i = 0; $__LIST__ = $gz;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
                                   <a target="_blank" href="<?php echo U('HotelDesc/index', 'id='.$val['hotel_id'].'&city=广州');?>">
                                       <img src="http://jiudian.cncn.com/photo/63/62565_m.jpg" class="lazy "
                                            data-original="http://jiudian.cncn.com/photo/63/62565_m.jpg"
                                            style="width: 210px; height: 140px;
                                            display: block;" alt="广州<?php echo ($val["hotel_name"]); ?>">
                                       广州<?php echo ($val["hotel_name"]); ?>
                                   </a>
                                   <p>星级：<span class="star4e1" title="欣欣用户评定为高档型酒店"></span></p>
                   ...
                   <div class="txt txt1" style="display: none;">
                       <ul>
                           <?php if(is_array($sz)): $i = 0; $__LIST__ = $sz;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
                                   ...
                                   <p>星级：<span class="star4e1"
                                               title="欣欣用户评定为高档型酒店"></span></p>
                                   <p class="price">价格：<em>￥<b><?php echo ($val["hotel_price"]); ?></b></em></p>
                                   <p>位置：<?php echo ($val["hotel_addr"]); ?></p>
                               </li><?php endforeach; endif; else: echo "" ;endif; ?>
                   ...
                   <div class="txt txt1" style="display: none;">
                       <ul>
                           <?php if(is_array($dg)): $i = 0; $__LIST__ = $dg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
                   ...
                   <div class="txt txt1" style="display: none;">
                       <ul>
                           <?php if(is_array($hz)): $i = 0; $__LIST__ = $hz;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
                                   <a target="_blank" href="http://jiudian.cncn.com/hotel-328704"><img
                                           src="http://jiudian.cncn.com/photo/329/328704_m.jpg" class="lazy "
                                           data-original="http://jiudian.cncn.com/photo/329/328704_m.jpg"
                                           style="width: 210px; height: 140px; display: block;" alt="东莞厚街天天住宿">
                   ...
                   <div class="txt txt1" style="display: none;">
                       <ul>
                           <?php if(is_array($zs)): $i = 0; $__LIST__ = $zs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
                                   <a target="_blank" href="http://jiudian.cncn.com/hotel-328704"><img
                                           src="http://jiudian.cncn.com/photo/329/328704_m.jpg" class="lazy "
                                           data-original="http://jiudian.cncn.com/photo/329/328704_m.jpg"
                                           style="width: 210px; height: 140px; display: block;" alt="东莞厚街天天住宿">
                   ...
                   <div class="txt txt1" style="display: none;">
                       <ul>
                           <?php if(is_array($fs)): $i = 0; $__LIST__ = $fs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
                                   <a target="_blank" href="http://jiudian.cncn.com/hotel-328704"><img
                                           src="http://jiudian.cncn.com/photo/329/328704_m.jpg" class="lazy "
                                           data-original="http://jiudian.cncn.com/photo/329/328704_m.jpg"
                                           style="width: 210px; height: 140px; display: block;" alt="东莞厚街天天住宿">
