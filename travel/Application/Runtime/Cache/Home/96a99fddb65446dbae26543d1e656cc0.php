        ...
        <div class="box_change">
            <div class="change_con">
                <dl>
                    ...
                    <dd>
                        ...
                        <?php if(is_array($days)): foreach($days as $key=>$v): if($v["days_id"] == 3): ?><a href="<?php echo U('Home/Line/get_days?days_id='.$v['days_id']);?>" class="on">三日游</a>
            ...
            <div class="change_ing">
                <dl>
                    <dt>您已选择：</dt>
                    <dd>
                        <a href="<?php echo U('Home/Line/index');?>" class="now_color">三日游<i></i></a>
