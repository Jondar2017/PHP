        ...
        <div class="box_change">
            <div class="change_con">
                <dl>
                    <dt>行程天数：</dt>
                    <dd>
                        <a href="<?php echo U('Home/LineCity/index?city_name='.$city_name);?>">全部</a>
                        <?php if(is_array($days)): foreach($days as $key=>$v): if($v["days_id"] == 2): ?><a href="<?php echo U('Home/LineCity/get_days?days_id='.$v['days_id'].'&city_name='.$city_name);?>" class="on">两日游</a>
                                <?php else: ?><a href="<?php echo U('Home/LineCity/get_days?days_id='.$v['days_id'].'&city_name='.$city_name);?>"><?php echo ($v["days_id"]); ?>日游</a><?php endif; endforeach; endif; ?>
                    </dd>
                </dl>
            ...
            <div class="change_ing">
                <dl>
                    <dt>您已选择：</dt>
                    <dd>
                        <a href="<?php echo U('Home/LineCity/index?city_name='.$city_name);?>" class="now_color">两日游<i></i></a>
                        <a href="<?php echo U('Home/LineCity/index?city_name='.$city_name);?>" class="btn_now">重新筛选</a>
                    </dd>
                </dl>
            </div>
            <script>
